path = "Java\JavaHomework\Homework_12\PythonVersion/Phone_books/phonebook.txt"
num = 1


def add_file(name_file: str):
    global path
    path = "Java\JavaHomework\Homework_12\PythonVersion/Phone_books/"

    with open(f"Java\JavaHomework\Homework_12\PythonVersion/all_files.txt", "a", encoding="UTF-8") as data:
        data.write(name_file + ".txt\n")

    with open(f"Java\JavaHomework\Homework_12\PythonVersion/Phone_books/{name_file}.txt", "w", encoding="UTF-8") as data:
        data.write("")
...
def open_file():
    ...
    with open(f"Java\JavaHomework\Homework_12\PythonVersion/all_files.txt", encoding="UTF-8") as data:
